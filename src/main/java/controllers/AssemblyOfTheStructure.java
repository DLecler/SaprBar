...
public class AssemblyOfTheStructure {
    ...
    @FXML
    private Button ADD_ROD_Button, DELETE_ROD_Button, CHANGE_Rod_Button, Next_Button;
    @FXML
    ...
    public void switchToSceneDOCUMENTATION(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("documentation_assembly.fxml"));
    ...
    @FXML
    public void switchToSceneCreateFile(ActionEvent event) throws IOException {
        if (!Next_Button.isDisabled() && (constr_get_SL || constr_get_SR)) {
            Parent root = FXMLLoader.load(getClass().getResource("createFile.fxml"));
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
    ...
    public void initialize() {
        ...
        ADD_ROD_Button.setOnAction(event -> {
            ...
            if (data_to_calc.constraction_map.size() != 0)
    ...
    public static void printArrow(GraphicsContext ctx, int index, double x1, double x2, double y, Construction data) {
    ...
    public static void printRodData(GraphicsContext ctx, int i, double x, double y, int font_size) {
        ...
        E_double = data_to_calc.constraction_map.get(i).getE();
        A_double = data_to_calc.constraction_map.get(i).getA();
        ctx.fillText(String.format("%sE, %sA", E_double, A_double), x, y);
    ...
    public void draw() {
        ...
        for (int i = 0; i < data_to_render.constraction_map.size(); i++) {
            ...
            printRodData(ctx, i, x2 - (x2 - x1) * 0.5, -(y1 + 15), 15);

            startX += data_to_render.constraction_map.get(i).getL();

            printArrow(ctx, i, x1, x2, 15, data_to_render);
